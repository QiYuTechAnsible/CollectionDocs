...
.. _ansible_collections.qiyutech.foreman.api_users_post_module:
...
qiyutech.foreman.api_users_post module -- Create a user
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_users_post`.
...
- Create a user
- 
- doc: https://ksle.2cc.net/apidoc/v2/users/create
