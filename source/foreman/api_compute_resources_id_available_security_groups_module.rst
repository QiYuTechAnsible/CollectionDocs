...
.. _ansible_collections.qiyutech.foreman.api_compute_resources_id_available_security_groups_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_compute_resources_id_available_security_groups`.
