...
.. _ansible_collections.qiyutech.foreman.api_hosts_post_module:
...
qiyutech.foreman.api_hosts_post module -- Create a host
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_hosts_post`.
...
- Create a host
- 
- doc: https://ksle.2cc.net/apidoc/v2/hosts/create
