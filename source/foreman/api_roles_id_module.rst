...
.. _ansible_collections.qiyutech.foreman.api_roles_id_module:
...
qiyutech.foreman.api_roles_id module -- Show a role
+++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_roles_id`.
...
- Show a role
- 
- doc: https://ksle.2cc.net/apidoc/v2/roles/show
