...
.. _ansible_collections.qiyutech.foreman.api_hosts_module:
...
qiyutech.foreman.api_hosts module -- List all hosts
+++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_hosts`.
