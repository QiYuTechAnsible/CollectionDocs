...
.. _ansible_collections.qiyutech.foreman.api_filters_id_module:
...
qiyutech.foreman.api_filters_id module -- Show a filter
+++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_filters_id`.
...
- Show a filter
- 
- doc: https://ksle.2cc.net/apidoc/v2/filters/show
