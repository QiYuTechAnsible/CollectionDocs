...
.. _ansible_collections.qiyutech.foreman.api_filters_id_put_module:
...
qiyutech.foreman.api_filters_id_put module -- Update a filter
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_filters_id_put`.
...
- Update a filter
- 
- doc: https://ksle.2cc.net/apidoc/v2/filters/update
