...
.. _ansible_collections.qiyutech.foreman.api_realms_id_module:
...
qiyutech.foreman.api_realms_id module -- Show a realm
+++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_realms_id`.
...
- Show a realm
- 
- doc: https://ksle.2cc.net/apidoc/v2/realms/show
