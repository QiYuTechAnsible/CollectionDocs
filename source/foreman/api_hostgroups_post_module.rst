...
.. _ansible_collections.qiyutech.foreman.api_hostgroups_post_module:
...
qiyutech.foreman.api_hostgroups_post module -- Create a host group
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_hostgroups_post`.
...
- Create a host group
- 
- doc: https://ksle.2cc.net/apidoc/v2/hostgroups/create
