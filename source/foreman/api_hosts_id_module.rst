...
.. _ansible_collections.qiyutech.foreman.api_hosts_id_module:
...
qiyutech.foreman.api_hosts_id module -- Show a host
+++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. note::
    ...
    To use it in a playbook, specify: :code:`qiyutech.foreman.api_hosts_id`.
...
- Show a host
- 
- doc: https://ksle.2cc.net/apidoc/v2/hosts/show
